...
export const MILKDROP_PRESET_NAMES = [
  ...
  "mstress - Scattered gravity (Smoked mix)",
  "geiss + mstress - Cleaning a path - Painterly Crossfire (Crisp Emboss Mix)",
  "_geiss + mstress - Cleaning a path - Painterly Crossfire (Crisp Emboss Mix)",
...
export const MILKDROP_PRESET_MAP: Record<string, string> = {
  ...
  "MilkDrop: Scattered Gravity": "mstress - Scattered gravity (Smoked mix)",
  "MilkDrop: Painterly Crossfire": "geiss + mstress - Cleaning a path - Painterly Crossfire (Crisp Emboss Mix)",
  "MilkDrop: Crisp Emboss": "_geiss + mstress - Cleaning a path - Painterly Crossfire (Crisp Emboss Mix)",
  "MilkDrop: Star Nova": "Fumbling_Foo & Flexi, Martin, Orb, Unchained - Star Nova v7b",
  "MilkDrop: Nerve Impulses": "Mstress - Acoustic Nerve Impulses",
};
