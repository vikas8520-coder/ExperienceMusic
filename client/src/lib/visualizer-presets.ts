...
export const presets = [
  ...
  "MilkDrop: Scattered Gravity",
  "MilkDrop: Painterly Crossfire",
  "MilkDrop: Crisp Emboss",
  "MilkDrop: Star Nova",
  "MilkDrop: Nerve Impulses",
] as const;
...
export const presetCategories = [
  ...
  },
  {
    ...
    presets: [
      ...
      { name: "MilkDrop: Scattered Gravity" as PresetName, icon: "milkdrop", shortName: "Gravity" },
      { name: "MilkDrop: Painterly Crossfire" as PresetName, icon: "milkdrop", shortName: "Crossfire" },
      { name: "MilkDrop: Crisp Emboss" as PresetName, icon: "milkdrop", shortName: "CrispEmboss" },
      { name: "MilkDrop: Star Nova" as PresetName, icon: "milkdrop", shortName: "StarNova" },
      { name: "MilkDrop: Nerve Impulses" as PresetName, icon: "milkdrop", shortName: "NerveImp" },
    ],
  },
] as const;
