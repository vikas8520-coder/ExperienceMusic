...
export const presetCategories = [
  {
    ...
    presets: [
      ...
      { name: "Psy Temple" as PresetName, icon: "fractal", shortName: "PsyTemple" },
    ],
  },
  {
    name: "Base",
  ...
  },
  {
    ...
    presets: [
      ...
      { name: "Tapestry Parallax" as PresetName, icon: "tapestry", shortName: "Tapestry" },
      { name: "Tapestry Zoom" as PresetName, icon: "tapestry", shortName: "TZoom" },
      { name: "McKenna Machine" as PresetName, icon: "tapestry", shortName: "McKenna" },
      { name: "Domain Warp" as PresetName, icon: "warp", shortName: "Warp" },
      { name: "Psy Mandala" as PresetName, icon: "mandala", shortName: "Mandala" },
      { name: "Fractal Flame" as PresetName, icon: "flame", shortName: "Flame" },
      { name: "Psy Voronoi" as PresetName, icon: "voronoi", shortName: "Voronoi" },
    ],
  },
  {
    name: "MilkDrop",
...
const presetEvolutionMap: Partial<Record<PresetName, { preset: EvolutionPreset; defaultBpm: number }>> = {
  ...
  "Tapestry Parallax": { preset: GENERIC_AI_EVOLUTION, defaultBpm: 130 },
  "Tapestry Zoom": { preset: GENERIC_AI_EVOLUTION, defaultBpm: 132 },
  "McKenna Machine": { preset: GENERIC_AI_EVOLUTION, defaultBpm: 128 },
  "Domain Warp": { preset: GENERIC_AI_EVOLUTION, defaultBpm: 126 },
  "Psy Mandala": { preset: GENERIC_AI_EVOLUTION, defaultBpm: 130 },
  "Fractal Flame": { preset: FRACTAL_AI_EVOLUTION, defaultBpm: 134 },
  "Psy Voronoi": { preset: GENERIC_AI_EVOLUTION, defaultBpm: 128 },
  ...
  "Psy Temple": { preset: FRACTAL_AI_EVOLUTION, defaultBpm: 138 },
};
